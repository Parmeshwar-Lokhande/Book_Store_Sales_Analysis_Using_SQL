...
Which books and categories generate the most revenue

Customer purchasing behavior

Sales performance across different orders

Opportunities to improve sales and customer engagement
...
Found high-value customers based on purchase amount

Analyzed monthly and overall sales trends

Determined revenue contribution by book and customer
...
Insights can be further visualized using Power BI / Tableau (optional)
...
Include advanced SQL concepts (CTEs, Window Functions)
